...
- The variance of population is 0.87, so we clearly notice the population variance is outside the 90% Confidence Interval with upper limit as 0.58 and 0.78.
- Also, It is also outside the 96% Confidence Interval with upper limit as 0.55 and 0.83.
...
- After comparing the results from Task 2.8 and Task 2.9 te, both answer came out to TRUE, means it we got enough evidence to reject the null hypothesis.
- Our p-value(0.001) also shows that there is difference is also very significant between the null and alternative hypothesis.
...
***Observations***
<P>
- Results shows that T-test value is not greater than right critical value and p-value is also smaller than alpha, 
- So, We can conclude that so we don't have enough evidence to reject the null hypothesis
