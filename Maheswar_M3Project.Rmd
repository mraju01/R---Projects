...
-- ***Applications of Hypothesis Testing in Criminal Justice System***
...
# Creating a new vector for fetching first 15  records
...
hSData %>%
  kbl(
    caption = "Table 2 : First 15 Observation of Data Set",
    format = "html"
  ) %>%
  kable_material_dark(
    full_width = F,
