...
#Table Creation of of Matrix Using Knitr Package
S1_Table_Rounded %>% 
  knitr::kable(caption = "Table 3: Z Values, Margin of Error, 
  Upper Confidence limit, Lower Confidence Limit and Width of C.I. of Sample 1 with Different Confidence Intervals",
   format = "html") %>%
     kable_classic(full_width = F, html_font = "Times New Roman")
